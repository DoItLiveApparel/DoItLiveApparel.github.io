...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('index-foundation.html'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/index-foundation.html'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/index-foundation.html'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for index-foundation.html in the named namespace
        $namedSource = $loader->getSource('@named/index-foundation.html');
        $this->assertEquals("named path\n", $namedSource);

        // get index-foundation.html from the main namespace
